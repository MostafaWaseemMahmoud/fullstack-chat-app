...
function SignUpPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Form Data", formData);
     if(!formData){
      return console.log("No Data Provided From The Form")
     }
    if(success === true){
      signup(formData)
    }
  ...
  return (
    <div className='m-h-screen grid lg:grid-cols-2 h-full'>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex item-center pointer-event-none">
